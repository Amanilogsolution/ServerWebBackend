...
const insertServiceGroup = async (req,res) =>{
    ...
    try{
        await sql.connect(sqlConfig)
        const result = await sql.query(`insert into IPERISCOPE.dbo.tbl_service_group_master (service_group_id ,service_group_type  ,service_group_description  ,Status,add_user_name,add_system_name,add_system_ip,add_date_time)
